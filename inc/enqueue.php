...
if ( ! function_exists( 'understrap_scripts' ) ) {
    ...
    function understrap_scripts() {
        ...
        // Enqueue custom CSS (make sure this is loaded after Bootstrap)
        $custom_css_version = $theme_version . '.' . filemtime( get_template_directory() . '/dist/css/custom-editor-style-bootstrap4.css' );
        wp_enqueue_style( 'custom-editor-style', get_template_directory_uri() . '/dist/css/custom-editor-style-bootstrap4.css', array('understrap-styles'), $custom_css_version );
...
error_log('Enqueue.php is being loaded');
